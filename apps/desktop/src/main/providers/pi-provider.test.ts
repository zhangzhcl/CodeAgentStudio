...
describe('PiProvider', () => {
  it('uses resume mode for the next prompt after restoring a native session', () => {
    expect(buildPiPromptArgs('sensenova', 'sensenova-6.8-flash-lite', 'session.jsonl', 'next', true)).toContain('--resume');
