...
import type { AgentProvider, CreateSessionInput, ProviderCapabilities, ProviderStatus, PromptOptions } from './contracts.js';

export class FakeProvider implements AgentProvider {
  readonly capabilities: ProviderCapabilities = { maxConcurrentSessions: 4, supportsResume: true, supportsAttachments: false, supportsImages: false, supportsThinking: false, supportsWebSearch: false, supportsProjectScope: true, supportsAbort: true };
