...
export class ProjectRepository {
  ...
  list(): RegisteredProject[] { return this.db.prepare("SELECT id, name, root_path as rootPath, COALESCE(source, 'native') as source FROM projects ORDER BY created_at").all() as RegisteredProject[]; }
